...
{
    /// <inheritdoc />
    public partial class SisAdminCreation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "Password", "Rol", "Username" },
                values: new object[,]
                {
                    { 1, "sisadmin@gmail.com", "sisadmin123", "sisAdmin", "sisAdmin" },
                    { 2, "JuanPerez@gmail.com", "juan123", "Admin", "juanPerez" },
                    { 3, "valencura@gmail.com", "valen123", "Client", "valenCura" }
                });
